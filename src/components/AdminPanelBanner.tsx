export default function AdminPanelBanner() {
  return (
    <section className="max-w-7xl mx-auto px-4 py-8">
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-amber-100 via-amber-50 to-yellow-100 dark:from-amber-900/30 dark:via-neutral-900 dark:to-yellow-900/20 border border-amber-300/50 dark:border-amber-700/30 p-6 sm:p-8">
        <div className="flex items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <span className="text-2xl">&#9881;&#65039;</span>
              <h2 className="font-heading font-bold text-xl text-amber-900 dark:text-amber-200">
