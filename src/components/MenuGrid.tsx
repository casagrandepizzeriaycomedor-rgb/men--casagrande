...
export default function MenuGrid({ items, categoryName, categoryNote }: MenuGridProps) {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-6">
      <div className="mb-4">
        <h2 className="text-2xl font-heading font-bold italic text-brand-brown dark:text-brand-cream">{categoryName}</h2>
        {categoryNote && (
          <p className="text-sm italic text-brand-green dark:text-brand-green-light mt-1">{categoryNote}</p>
        )}
      </div>
